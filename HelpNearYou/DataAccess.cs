...
namespace FormDesign
{
    public static class DataAccess
    {
        public static class DataAccess
        {
            ...
            internal static SqlConnection Connection = new SqlConnection(@"Data Source=DESKTOP-UA79V0N\SQLEXPRESS;Initial Catalog=reataurantmanagement;Integrated Security=True");
